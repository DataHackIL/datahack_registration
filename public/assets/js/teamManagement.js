$( document ).ready(function() {
    ...
    var maxMembers = 4;
    currentMember = [true,false,false,false];
    ...
    $('#add_mem').on('click', function() {
        ...
        if (i===4){
            alert('There is a limit of overall 5 team members.')
        }
    });
    ...
    $('.form-member-name').focusout(function(){
        ...
        if ($(this).val()!==""){
            ...
            $.ajax({url: "/users/"+$(this).val(), success: function(user){
                /*
                if (!user.accepted){
    ...
    $("#deleteTeamClk").click(function(e){
        ...
        if (window.confirm("Are you sure?")) {
            ...
            $.ajax({data:{'admin_email':userEmail} ,type:'DELETE', url: "/teams/"+teamId, success: function(result){
                modal({
                    type: 'success',
                    title: 'Success',
        ...
        $.ajax({
            ...
            success: function(data) {
                modal({
                    ...
                    animate:true,
                    callback:function(){window.location.replace("/team-up");}
                });
            },
            error: function (data) {
